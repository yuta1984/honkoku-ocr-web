...
function getStored(): OcrModelVersion {
  // v7/v8 は UI から廃止(localStorage に残っていても DEFAULT=v13 に migrate)。
  // v11/v12/v13 のみ残し、それ以外は DEFAULT へ。
  const v = localStorage.getItem(STORAGE_KEY)
  return v === 'v11' || v === 'v12' || v === 'v13' ? v : DEFAULT_OCR_VERSION
}

/**
 * OCR enc-dec モデルの版(v11/v12/v13)の保持と切替。localStorage に永続化する。
